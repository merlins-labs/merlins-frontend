    ...
    <>
      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <h5 className="text-furyverse-100 md:font-h6 md:text-h6">
        ...
        <div className="flex flex-wrap items-center place-content-around gap-4 rounded-xl border border-furyverse-600 py-2 px-3 text-furyverse-300">
