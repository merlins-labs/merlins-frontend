      ...
      <div className="relative">
        <input
          ...
          className={classNames(
            ...
            {
              "opacity-30 bg-furyverse-400": disabled && isOn,
              "opacity-10 bg-furyverse-400": disabled && !isOn,
              "bg-wfuryngton-200": !disabled && isOn,
              "cursor-pointer": isHovered && !disabled,
              "bg-wfuryngton-100": isHovered && !disabled && isOn,
              "bg-furyverse-900": !disabled && !isOn,
            },
            className
          )}
          checked={isOn}
